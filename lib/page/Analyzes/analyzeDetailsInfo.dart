...
@override
                ...
                margin: EdgeInsets.only(top: 30,right: 10,left: 10,bottom: 20),
                  child: Column(
                    children: <Widget>[
                      ...
                      textFieldTitle("number day work","۴ روز"),
                      title('مجموع ساعت کاری در هر روز:'),
                      textFieldTitle("total time work","۵۰ ساعت"),
                      title('سبک زندگی:'),
                      DropDown("lifeStyle",[
                      ...
                      ],"سبک زندگی",fontsize: 11.0,),
                      title('تعداد وعده های غذایی:'),
                      promise("۲ وعده","from times eat","۴ وعده","to times eat",'','تا' ),
                      title('تعداد دفعات دفع مدفوع در روز یا هفته:'),
                      promise("۲ وعده","from times exit","۱۰ وعده","to times exit"," در روز ", " در هفته"),
                      title('ساعت خواب به طور معمول:'),
                      promise("۲۲ ","hours sleap","۱۰","hours aweak","ساعت خواب ", " ساعت بیداری ",),
                      Button(["lifeStyle",
                      "number day work",
                      "total time work",
                      "from times eat",
                      ...
                      "to times exit",
                      "hours sleap",
                      "hours aweak",],"/StdAnalyzePage4","ادامه آنالیز",45.0,15.0,width: 120.0,)
                    ],
                  )
              )
            ],
  ...
  Widget textFieldTitle(id,hint) => Container(
          margin: EdgeInsets.only(
            left: (MediaQuery.of(context).size.width) / 3.5,
            right: (MediaQuery.of(context).size.width) / 3.5,
          ),
          height: 40,
          child: InputText(hint,id,hintconlor: Colors.green,textAlign: TextAlign.center,maxlenght: 10.0,)
      );
  ...
  Widget promise( hint1 ,id1,hint2 ,id2,text1,text2) => Container(
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Text(text1, style: TextStyle(color: Colors.white,fontSize: 14, fontWeight: FontWeight.bold),),

        Container(
          height: 35,
          width: 80 ,
          child:
          InputText(hint1, id1,hintconlor: Colors.green,textAlign: TextAlign.center,maxlenght: 10.0,),

        ),
        Text(text2, style: TextStyle(color: Colors.white,fontSize: 14, fontWeight: FontWeight.bold),),
        Container(
          height: 35,
          width: 80 ,
          child: InputText(hint2, id2,hintconlor: Colors.green,textAlign: TextAlign.center,maxlenght: 10.0,),
